...
* [查看一些浏览器的hack技巧](//browserhacks.com/)

    用一些css或js不常规技巧解决浏览器的兼容性问题

* [Charles 从入门到精通](//blog.devtang.com/2015/11/14/charles-introduction/)
...
* [Unix 时间戳 Unix timestamp](//tool.chinaz.com/Tools/unixtime.aspx)

- [在线正则表达式匹配](https://regex101.com/)
    - 这个功能更强大一点，能清楚的区分出贪婪和懒惰正则。
- [//regexr.com/](//regexr.com/)

* [css动画参考工具](//isux.tencent.com/css3/tools.html)
...
* [JavaScript 标准参考教程（alpha） -阮一峰](//javascript.ruanyifeng.com/)

* [JavaScript Promise迷你书 -azu](//liubin.org/promises-book/)
...
* [JavaScript 设计模式 系列 AlloyTeam](//www.alloyteam.com/2012/10/common-javascript-design-patterns/)

### ES2015

- [https://tc39.github.io/ecma262/](https://tc39.github.io/ecma262/)
* [//www.ecma-international.org/ecma-262/6.0/](//www.ecma-international.org/ecma-262/6.0/)

    ES2015规范

- [//es6katas.org/](//es6katas.org/)

    Learn ES6 by doing it. Fix failing tests. Keep all learnings.

* [30分钟掌握ES6/ES2015核心内容（上）](//segmentfault.com/a/1190000004365693)

* [30分钟掌握ES6/ES2015核心内容（下）](//segmentfault.com/a/1190000004368132)
...
* [Webpack傻瓜式指南（一） -前端外刊评论 知乎专栏](//zhuanlan.zhihu.com/FrontendMagazine/20367175)

* [Webpack傻瓜指南（二）开发和部署技巧 -前端外刊评论 知乎专栏](//zhuanlan.zhihu.com/FrontendMagazine/20397902)

* [Webpack傻瓜指南（三）和React配合开发 -前端外刊评论 知乎专栏](//zhuanlan.zhihu.com/FrontendMagazine/20522487)

    上述傻瓜指南的原始出处 [https://github.com/vikingmute/webpack-for-fools](https://github.com/vikingmute/webpack-for-fools) Webpack傻瓜式指南

* [Webpack，101入门体验 -Yika](//www.html-js.com/article/3009)
...
* [Vue.js 和 Webpack（一） -Randy Lu](//djyde.github.io/2015/08/29/vuejs-and-webpack-1/)
* [Vue.js 和 Webpack（二） -Randy Lu](//djyde.github.io/2015/08/30/vuejs-and-webpack-2/)
* [Vue.js 和 Webpack（三） -Randy Lu](//djyde.github.io/2015/08/31/vuejs-and-webpack-3/)
...
* [深入理解 React -Thinking in React 中文版](//reactjs.cn/react/docs/thinking-in-react.html)
* [Thinking in React](//facebook.github.io/react/docs/thinking-in-react.html)
...
* [AngularJS 教程 \| 菜鸟教程](//www.runoob.com/angularjs/angularjs-tutorial.html)

    类似 w3school 的入门 AngularJS 教程。

### 测试

* [测试框架 Mocha 实例教程 阮一峰](//www.ruanyifeng.com/blog/2015/12/a-mocha-tutorial-of-examples.html)
...
* [后端程序员的 JavaScript 之旅 - 模块化（一）](//lishaopeng.com/2016/02/05/js-module/)
* [后端程序员的 JavaScript 之旅 - 模块化（二）](//lishaopeng.com/2016/02/11/js-module2/)
* [后端程序员的 JavaScript 之旅 - 模块化（三）](//lishaopeng.com/2016/02/19/js-module3/)

* [CommonJS 规范 -来自 阮一峰 JavaScript 标准参考教程(alpha)](//javascript.ruanyifeng.com/nodejs/module.html)

## other articles

- [<head> Cheat Sheet](//gethead.info/)
...
* [Gitbook 的使用和常用插件 -赵达](//zhaoda.net/2015/11/09/gitbook-plugins/)
* [gitbook-plugin-expandable-chapters](https://plugins.gitbook.com/plugin/expandable-chapters)

    折叠左侧目录章节。

    <!-- ![](//ww4.sinaimg.cn/large/7011d6cfjw1f08kmplbj1j20gn05l0tk.jpg) -->
...
* [Chrome扩展及应用开发 -图灵电子书](//www.ituring.com.cn/minibook/950)
...
- [COLORFUL xiaoa](//www.xiaoa.name/)

* [进击的马斯特 //pinkyjie.com/](//pinkyjie.com/)
...
* [小胡子哥 //www.barretlee.com/](//www.barretlee.com/)

    李靖，阿里巴巴。

* [Xcat Liu //blog.xcatliu.com/](//blog.xcatliu.com/)

    Microsoft Software Engineer II, Meituan Senior Front-End Engineer

* [极限前端 //ouvens.github.io/](//ouvens.github.io/)

    Ouvenzhang, 前端工程师，对前端领域的技术知识具有较高的职业能力和探究精神。对响应式页面设计、工程构建组件化、mv*设计实现、前端优化、ES6开发体系等有深入的研究与项目实践。来自腾讯科技。

* [凳子_Joinery 邓智容  //www.dengzhr.com/](//www.dengzhr.com/)

* [赵达的个人网站 腾讯高级前端开发工程师](//zhaoda.net/)

* [Randy](//djyde.github.io/)

    95年出生的全栈。卢涛南，英文名 Randy，用 djyde 这个ID混迹于网络。

* [JS前端开发群月报 -豪情等人维护](//www.kancloud.cn/jsfront/month/82796)
